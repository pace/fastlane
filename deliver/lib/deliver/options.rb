    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :edit_live,
                                     ...
                                     description: "Modify live metadata, this option disables ipa upload, screenshot and preview upload",
                                     type: Boolean),
        ...
        FastlaneCore::ConfigItem.new(key: :skip_metadata,
                                     ...
                                     description: "Don't upload the metadata (e.g. title, description). This will still upload screenshots and previews",
                                     type: Boolean,
                                     default_value: false),
